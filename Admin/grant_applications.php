...
<body>
    ...
    <main class="main-content">
        <h2 class="mb-4">Grant Applications Management</h2>
        ...
        <div class="data-table-container">
            <div class="table-header">
                <h5><i class="fas fa-list"></i> Grant Applications</h5>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewDetailsModalLabel">Grant Application Details</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="approveModalLabel">Approve Grant Application</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to approve this grant application?</p>
                    <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="rejectModalLabel">Reject Grant Application</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Please provide a reason for rejecting this grant application:</p>
                    <div class="mb-3">
    ...
    <script>
        ...
        function loadStatistics() {
            fetch('api/grant_applications_api.php?action=get_stats')
        ...
        function loadApplications() {
            ...
            fetch(`api/grant_applications_api.php?${params}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function displayApplications(applications) {
            ...
            tbody.innerHTML = applications.map(app => `
                <tr>
                    ...
                    <td>${app.grant_type}</td>
                    <td>₦${parseFloat(app.amount_requested).toLocaleString()}</td>
        ...
        function viewDetails(applicationId) {
            ...
            fetch(`api/grant_applications_api.php?action=get_details&id=${applicationId}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function displayApplicationDetails(app) {
            ...
            const html = `
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h6 class="text-primary mb-3"><i class="fas fa-hand-holding-usd"></i> Grant Details</h6>
                        <table class="table table-sm">
                            <tr><th>Provider:</th><td>${app.provider_name}</td></tr>
                            <tr><th>Grant Type:</th><td><strong>${app.grant_type}</strong></td></tr>
                            <tr><th>Amount Requested:</th><td><strong>₦${parseFloat(app.amount_requested).toLocaleString()}</strong></td></tr>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h6 class="text-primary mb-3"><i class="fas fa-lightbulb"></i> Project Details</h6>
                        <table class="table table-sm">
                            <tr><th>Business Plan:</th><td>${app.business_plan ? app.business_plan.substring(0, 100) + '...' : 'N/A'}</td></tr>
                            <tr><th>Expected Impact:</th><td>${app.expected_impact || 'N/A'}</td></tr>
                            <tr><th>Farm Size:</th><td>${app.farm_size || 'N/A'}</td></tr>
                            <tr><th>Experience:</th><td>${app.years_of_experience || 'N/A'} years</td></tr>
                        </table>
                    </div>
                    <div class="col-md-6">
        ...
        function approveApplication() {
            ...
            fetch('api/grant_applications_api.php?action=approve', {
                method: 'POST',
        ...
        function rejectApplication() {
            ...
            fetch('api/grant_applications_api.php?action=reject', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    id: currentApplicationId,
        ...
        function deleteApplication(applicationId) {
            ...
            fetch('api/grant_applications_api.php?action=delete', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
