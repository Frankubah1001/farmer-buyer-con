...
<body>
    ...
    <main class="main-content">
        <h2 class="mb-4">Loan Applications Management</h2>
        ...
        <div class="data-table-container">
            <div class="table-header">
                <h5><i class="fas fa-list"></i> Loan Applications</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="rejectModalLabel">Reject Loan Application</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        function loadStatistics() {
            fetch('api/loan_applications_api.php?action=get_stats')
        ...
        function loadApplications() {
            ...
            fetch(`api/loan_applications_api.php?${params}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function displayApplications(applications) {
            ...
            tbody.innerHTML = applications.map(app => `
                <tr>
                    ...
                    <td>₦${parseFloat(app.loan_amount).toLocaleString()}</td>
                    <td>${app.repayment_period_months} months</td>
        ...
        function viewDetails(applicationId) {
            ...
            fetch(`api/loan_applications_api.php?action=get_details&id=${applicationId}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function displayApplicationDetails(app) {
            ...
            const html = `
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h6 class="text-primary mb-3"><i class="fas fa-file-invoice-dollar"></i> Loan Details</h6>
                        <table class="table table-sm">
                            <tr><th>Platform:</th><td>${app.loan_platform}</td></tr>
                            <tr><th>Amount:</th><td><strong>₦${parseFloat(app.loan_amount).toLocaleString()}</strong></td></tr>
                            <tr><th>Repayment Period:</th><td>${app.repayment_period_months} months</td></tr>
                            <tr><th>Purpose:</th><td>${app.loan_purpose}</td></tr>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <table class="table table-sm">
                            <tr><th>Bank Name:</th><td>${app.bank_name}</td></tr>
                            <tr><th>Account Number:</th><td>${app.account_number}</td></tr>
                            <tr><th>Account Name:</th><td>${app.account_name}</td></tr>
                        </table>
                    </div>
                    <div class="col-md-6">
        ...
        function approveApplication() {
            ...
            fetch('api/loan_applications_api.php?action=approve', {
                method: 'POST',
        ...
        function rejectApplication() {
            ...
            fetch('api/loan_applications_api.php?action=reject', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    id: currentApplicationId,
        ...
        function deleteApplication(applicationId) {
            ...
            fetch('api/loan_applications_api.php?action=delete', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
