<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="buyersDashboard.php">
        <div class="sidebar-brand-text mx-3">F & B  <sup>Connect</sup></div>
    </a>
    <hr class="sidebar-divider my-0">
    <!-- Nav Items -->
    <li class="nav-item active">
        <a class="nav-link" href="buyersDashboard.php">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="buyer_view_product.php">View Farm Products</a>
...
<!-- Nav Item - Charts -->
<li class="nav-item">
    <a class="nav-link" href="buyer_view_farmer.php">
...
<!-- Nav Item - Tables -->
<li class="nav-item">
    <a class="nav-link" href="buyerprofile.php">
        <i class="fas fa-fw fa-user-edit"></i>
        <span>Profile</span></a>
</li>
<li class="nav-item">
    <a class="nav-link" href="Buyer_change_password.php">
        <i class="far fa-fw fa-edit"></i>
        <span>Change Password</span></a>
</li>

<li class="nav-item">
    <a class="nav-link" href="Buyerlogout.php" id="logoutBtn">
