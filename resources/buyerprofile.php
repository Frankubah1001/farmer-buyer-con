...
<script>
  ...
  window.onload = () => {
    fetch('views/get_buyer_info.view.php')
        ...
        .then(data => {
            if (data && !data.error) {
                ...
                profilePicImg.src = data.profile_picture || 'views/uploads/profile_pics/';
                originalData = { ...data };
  ...
  cancelBtn.addEventListener('click', () => {
    ...
    profilePicImg.src = originalData.profile_picture || 'views/uploads/profile_pics/';
  ...
  saveBtn.addEventListener('click', function(e) {
    ...
    if (isEditing) {
        ...
        fetch('update_buyer_info.php', {
            method: 'POST',
            body: formData
        })
        .then(response => response.text())
        .then(data => {
            console.log('Response from update_buyer_info.php:', data);
